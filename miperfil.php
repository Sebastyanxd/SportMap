    ...
    <style>
        * {
        ...
        body {
            ...
            color: #fff;
            line-height: 1.6;
            background-image: url('./images/fondofutbol.jpg');
            display: flex;
        ...
        .container {
            ...
            align-items: center;
            padding: 20px;
            margin-top: 120px; /* Add margin-top to position the container lower */
        }
                ...
                <div class="profile-details">
                    <div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="tel" id="telefono" name="telefono" class="form-control" value="<?php echo htmlspecialchars($usuario['Telefono'] ?? ''); ?>">
                        </div>
                    </div>
                    <div>
                        <div class="form-group">
